...
class VNet(nn.Module):
    ...
    def __init__(self, inplanes, num_classes, width, norm_layer=None, deep_supervision=False, dropout=0,
        ...
        self.down_layer3 = DownTransition(features[2], 3, dropout=True, norm_layer)
        self.down_layer4 = DownTransition(features[3], 2, dropout=True, norm_layer)
        self.up_layer1 = UpTransition(features[3], features[3], 2, dropout=True, norm_layer)
        self.up_layer2 = UpTransition(features[3], features[2], 2, dropout=True, norm_layer)
